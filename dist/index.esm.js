...
var _lodash2 = _interopRequireDefault(throttle);
...
var _reactDisplayName2 = _interopRequireDefault(getDisplayName_1);
  ...
  var ScrollingComponent = function (_Component) {
    ...
    function ScrollingComponent(props, ctx) {
      ...
      _this.updateScrolling = (0, _lodash2.default)(function (evt) {
        ...
        var coords = (0, util.getCoords)(evt);
    ...
    _createClass(ScrollingComponent, [{
      ...
      value: function componentDidMount() {
        ...
        this.container = (0, reactDom.findDOMNode)(this.wrappedInstance);
...
var lib_1 = lib.defaultVerticalStrength;
var lib_2 = lib.defaultHorizontalStrength;
var lib_3 = lib.createHorizontalStrength;
var lib_4 = lib.createVerticalStrength;
var lib_5 = lib.createScrollingComponent;
  ...
  _createClass(DndManager, [{
    ...
    value: function wrapTarget(el) {
      ...
      var nodeDropTarget = {
        ...
        hover: throttle(function (dropTargetProps, monitor, component) {
          ...
          var draggedNode = monitorItem.node;
    ...
    value: function wrapRoot(el) {
      return DragDropContext$1(HTML5Backend)(el);
    }
  }]);
...
function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    if (isVirtualized) {
      _this.scrollZoneVirtualList = (lib_5 || withScrolling)(List);
      _this.vStrength = lib_4(slideRegionSize);
      _this.hStrength = lib_3(slideRegionSize);
    }
